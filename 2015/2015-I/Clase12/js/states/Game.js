...
Game.prototype = {
  create:function(){
    ...
    this.coinPool.enableBody = true;
      ...
      this.floorPool,12,0,200,-this.worldSpeed, this.coinPool);
  ...
  update:function(){
      ...
      this.game.physics.arcade.overlap(this.player,this.coinPool, 
  ...
  share:function(){
  	...
  	/*FB.ui(
    {
      ...
      description: 'Obtuve un puntaje de '+ this.coins
    },function(response){});*/
  ...
  generateRandomPlatform:function(){
  	...
  	data.separation = minSeparation + 
  						Math.random()*(maxSperation-minSeparation);
  	var minDifY = -120;
  	var maxDifY = 120;
